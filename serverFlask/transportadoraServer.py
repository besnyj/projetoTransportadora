...
app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:///usersLogReg.db'
...
class User(db.Model):
    ...
    posts = db.relationship('Post', backref='author', lazy=True) # not related to Column, this will query the users' posts
